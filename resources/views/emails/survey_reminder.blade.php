                          ...
                          <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                            ...
                            <tr>
                              <td align="center" class="hund ripplelink" width="600">
                                <img align="center" width="600" style="border-radius: 3px 3px 0px 0px; width: 100%; max-width: 600px!important" class="hund" src="{{ $message->embed(public_path() . '/img/email_header.jpeg') }}">
                              </td>
                            </tr>
                            <!-- END HEADER IMAGE -->
                            <!-- START BODY COPY -->
                  ...
                  <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                    <tr>
                      ...
                      <td align="center" width="300" style="padding-top: 0px!important; padding-bottom: 18px!important; mso-padding-alt: 0px 0px 18px 0px;">
                        <table border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td align="right" valign="top" class="social">
                              <a href="https://www.facebook.com/CommunityTaxLLC"
                              target="_blank">
                          ...
                          <td width="20"></td>
                          <td align="right" valign="top" class="social">
                            <a href="https://twitter.com/communitytaxllc"
                            target="_blank">
                        ...
                        <td width="20"></td>
                        <td align="right" valign="top" class="social">
                          <a href="http://www.linkedin.com/company/community-tax-relief-llc"
                          target="_blank">
                      ...
                      <td width="20"></td>
                      <td align="right" valign="top" class="social">
                        <a href="http://www.youtube.com/CommunityTax"
                        target="_blank">
