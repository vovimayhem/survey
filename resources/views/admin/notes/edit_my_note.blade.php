@extends('layouts.app')
@section('page_heading','Edit My Note')
@section('section')
<div class="col-md-12">
	@if ($errors->any())
	...
	@endif
	<form action="{{ route('notes.update.mynote', $note->id) }}" method="POST">
		...
		<div class="form-group">
			<div class="text-right">
				...
				@include('widgets.button', array('href'=>"/admin/notes/mynotes", 'class'=>'danger btn-outline', 'size'=>'sm', 'value'=>'Cancel'))
			</div>
		</div>
	</form>
</div>
